...
class AuthControllerTest {
    ...
    void login_shouldReturn200AndBearerTokenForValidCredentials() throws Exception {
        ...
        mockMvc.perform(post("/auth/login")
                        ...
                        .content(objectMapper.writeValueAsString(
                                new AuthDtos.LoginRequest("admin@tus.ie", "Admin@123"))))
    ...
    void login_shouldReturn401ForInvalidCredentials() throws Exception {
        ...
        mockMvc.perform(post("/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                new AuthDtos.LoginRequest("admin@tus.ie", "wrong-password"))))
    ...
    @Test
    void login_shouldReturn401WhenInvalidCredentialsWrapped() throws Exception {

        ResponseEntity<Map<String, Object>> response =
                authExceptionHandler.handleAny(
                        new ServletException(new InvalidCredentialsException("Invalid credentials"))
                );
